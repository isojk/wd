...
function hook {
    ...
    process {
        $InstallationHandlers[$APP_ID] = {
            ...
            process {
                wdChocoInstallPackage -Id "${APP_ID}"
            }
        }
        ...
        $ConfigurationHandlers[$APP_ID] = {
            ...
            process {
                ...
                $target_data_basedur = "$data\keypirinha"
                ...
                if ($Level -gt 0) {
                    ...
                    # link Keypirinha.ini
                    wdCoreFSLink -Source "$app_data_basedir\Keypirinha.ini" -Target "$target_data_basedur\Keypirinha.ini"
                }
            }
        }
    }
